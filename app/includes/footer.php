    ...
    <div class="footer-content">
        <div class="footer-section about">
            ...
            <p style="font-size:15px">
                Computer learning Channel is an interesting Channel
            </p>
            <div class="contact">
                <span style="font-size:15px"><i class="fas fa-phone"></i> &nbsp; 123-456-789</span>
                <span style="font-size:15px"><i class="fas fa-envelope"></i> &nbsp; Henry.Chan@polyu.edu.com</span>
            </div>
            <div class="socials">
